...
function manResPagination(noRow) {
  let options = {
    ...
    callback: function (data, pagination) {
      ...
      data.forEach((csvD) => {
        ...
        // manage result table head start
      let mng_result_head = `<div id="style1Table">
    <table id="resizable554" class="mytablesty12">
        <thead>
          <tr class="dnd-moved">
              <!-- Add class dnd-moved by ASHIQ-->
  ...
  <div class="left-slider5">
      ...
      let manage_wrap = $("#outer_table_box7");
        manage_wrap.html(mng_result_head);

      $("#style1Table").freezeTable({
          'freezeColumn': false,
      });
      // manage result table head end
