  ...
  $("#exelFile").change((e) => {
    ...
    if (recExelFile) {
      ...
      fileReader.onload = (e) => {
        ...
        if (wb && sheet) {
          const tableData = XLSX.utils.sheet_to_json(wb.Sheets[sheet]);
          let options = {
                    ...
                    <div class="icon-box22">
                      ...
                      <div class="circle2box">
                        <svg class="svg1" viewBox="-21 0 512 512">
                          <g>
                            <path
                              d="M406,60h-30v15c0,24.814-20.186,45-45,45H181c-24.814,0-45-20.186-45-45V60h-30c-24.814,0-45,20.186-45,45v360
