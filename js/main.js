...
listItemData.forEach((item, index) => {
  ...
  for (let i = 1; i <= length; i++) {
      if (length < 61) {
          if (i <= 20) {
              list_data1 += `<div class="inputGroup">
                  <input id="level${index + 1}_item${i}" type="checkbox" />
                  <label for="level${index + 1}_item${i}">
                      Level ${index + 1} - Item ${i}
                  </label>
              </div>`;
          } else if (i >= 21 && i <= 40) {
              list_data2 += `<div class="inputGroup">
                  <input id="level${index + 1}_item${i}" type="checkbox" />
                  <label for="level${index + 1}_item${i}">
                      Level ${index + 1} - Item ${i}
                  </label>
              ...
              list_data3 += `<div class="inputGroup">
                  <input id="level${index + 1}_item${i}" type="checkbox" />
                  <label for="level${index + 1}_item${i}">
                      Level ${index + 1} - Item ${i}
                  </label>
  ...
  sub_ul_list.innerHTML += `<form id="item-form-${ index + 1 }" class="level-item-form">
      <div class="sub-list" id="sub-div-list-1-${index + 1}">
          ${list_data1}
      </div>
      <div class="sub-list" id="sub-div-list-2-${index + 1}">
          ${list_data2}
      </div>
      <div class="sub-list" id="sub-div-list-3-${index + 1}">
          ${list_data3}
      </div>
      </form>`;
...
main_list.addEventListener("click", function (e) {
  ...
  $(".highlight_li .arrow-li-box-background-color-2").addClass(
    "arrow-li-box-background-color-1"
  );
  $(".highlight_li .arrow-li-box-background-color-2").removeClass(
